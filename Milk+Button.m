...
@implementation NSButtonCell(MilkDefaultButtonAnimation)
- (void)setIsDefaultButton:(NSNumber*) val
{
  objc_setAssociatedObject(self, kMilkIsDefaultButton, val, OBJC_ASSOCIATION_COPY);
}

- (NSNumber *) isDefaultButton
{
	return objc_getAssociatedObject(self, kMilkIsDefaultButton);
}
- (BOOL)defaultButton
{
...
{
	objc_setAssociatedObject(self, kMilkPulseProgressKey, pulseProgress, OBJC_ASSOCIATION_COPY);
}

- (NSNumber*)pulseProgress
{
	return objc_getAssociatedObject(self, kMilkPulseProgressKey);
}
@end

@implementation Milk(MilkButton)
