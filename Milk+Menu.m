...
@interface Milk(MilkMenu)

@end

@implementation Milk(MilkMenu)
...
- (NSColor *) menuBackgroundColor
{
  ...
  float transparency = [theme_defaults floatForKey:@"MilkMenuBarTransparency"];    
                                   ...
                                   isHorizontal: (BOOL)isHorizontal
{
  ...
  NSColor* selectedBackgroundColor1 = [NSColor colorWithCalibratedRed: 0.9 green: 0.9 blue: 0.9 alpha: 1];
  NSColor* selectedBackgroundColor2 = [NSColor colorWithCalibratedRed: 0.8 green: 0.8 blue: 0.8 alpha: 1];
