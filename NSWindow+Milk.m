#include "Milk+Button.h"
#include "MilkWindowButton.h"
  ...
  switch (button)
    {
      case NSWindowCloseButton:
        newButton = [[MilkWindowButton alloc] init];
        [newButton setBaseColor: [NSColor colorWithCalibratedRed: 0.9 green: 0.9 blue: 0.9 alpha: 1]];
